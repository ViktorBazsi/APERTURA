  ...
  return (
    <>
      <PageHero
        ...
        description="A kapcsolatoldal mock tartalommal készül, de a felépítés már alkalmas valódi kapcsolatkezelés és leadgyűjtés fogadására."
        meta="A közösségi linkek, címadatok és az űrlap külön adatforrásra vagy CMS-re is könnyen köthetők később."
      />
      ...
      <Section>
        <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="space-y-5">
            ...
            <div className="surface h-64 p-8">
              <p className="text-sm uppercase tracking-[0.24em] text-canvas/45">Helyszín</p>
              <div className="mt-6 flex h-[calc(100%-3rem)] items-center justify-center rounded-[24px] border border-dashed border-white/15 bg-white/[0.03] text-sm text-canvas/40">
                Map placeholder
              </div>
            </div>
          </div>
